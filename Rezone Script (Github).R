...
These colour ramps require the RcolorBrewer pacakge
rbPal = colorRampPalette(c('red','blue'))
cols_out = colorRampPalette(c('white',"pink", "yellow", "lime green"))(length(breaks) - 1)
#functions-------------------
#source the script with all the Rezone functions
source('')
...
#Pareto optimisation
par_out = pareto_func(ras_value ,conf) 
plot(ras_value)
